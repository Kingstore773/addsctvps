...
replace_credit_name() {
    ...
    sed -i "s/@KingStoreGanteng/@$new_name/g" "/var/www/pterodactyl/app/Http/Middleware/CustomSecurityCheck.php"
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($server instanceof Server) {
            ...
            if ($this->isRestrictedFileAction($path, $method, $request)) {
                ...
                return $this->deny($request, 'Mau ngapain hama? - @KingStoreGanteng');
            }
        }
